...
download ${zlibArchive} https://ftp.osuosl.org/pub/libpng/src/zlib/${zlibArchive}
cd ${top}
...
buildBinutils ${buildNative} ${installNative} "" "--build=${hostTriplet} --host=${hostTriplet}" 
...
buildGccFinal "--enable-languages=c,c++,lto -final" "-Os" "${installNative}"
